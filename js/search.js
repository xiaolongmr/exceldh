...
var listIndex = -1;
var hotList = 0;
var thisSearch = 'https://soupian.app/search?key=';
...
$(function() {
    ...
    var search = {
        data: [{
                name: '影视',
            icon: 'https://img.z-l.top/file/dh/LMxBIW5b.png',
                color: '#d2f2f4',
            ...
            {
                name: '维修手册',
                icon: 'https://gimg3.baidu.com/gimg/app=2028&src=pic.rmb.bdstatic.com/bjh/3ed1230b8bc7a5a/250419/b2232ede989798ede52106b851e0fe38.png',
                color: '#d2f2f4',
                url: 'https://zh.ifixit.com/Search?query='
            },
            {
                name: '秘塔AI',
                icon: 'https://free.xn--fiqs8s/static/searchEngine/mita.svg',
                color: '#4c8bf5',
                url: 'https://metaso.cn/search/ae4dc242-5d08-4b8c-9c86-de0206db3327?q='
            }, {
                name: '百度',
                ...
                name: 'B 站',
                icon: 'https://img.z-l.top/file/dh/Mywd6vx2.webp',
                color: '#f45a8d',
                url: 'http://search.bilibili.com/all?keyword='
            }, {
                name: 'VR全景',
                icon: 'https://img.z-l.top/file/dh/b2GJ2wtu.webp',
                color: '#148aff',
